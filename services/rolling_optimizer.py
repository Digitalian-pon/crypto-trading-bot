...
class RollingOptimizer:
    ...
    def __init__(self):
        ...
        # v3.27.2: BE下限を0.005に引き上げ（0.003はノイズ刈りで往復ビンタの主因）
        self.param_grid = {
            'stop_loss_pct': [0.008, 0.010, 0.012],  # 上限1.2%（2.0%は損失過大のため除外）
            'breakeven_threshold': [0.005, 0.007, 0.010],  # v3.27.2: 0.003削除、0.010追加
        ...
        self.trailing_templates = {
            ...
            0.010: [
                (0.010, 0.0), (0.015, 0.010), (0.020, 0.015), (0.025, 0.020), (0.040, 0.030),
            ],
        }

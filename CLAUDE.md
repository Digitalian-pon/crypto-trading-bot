...
**最終更新**: 2026年1月16日 08:00
**ステータス**: 24時間完全稼働中 ✅ (最適化DOGE_JPYレバレッジ取引)
**バージョン**: 2.6.1 - Force Restart Fix ⭐**最新**
**現在の残高**: JPY 214円（前回比+¥15、+7.5%）
**現在のポジション**: SELL 10 DOGE @ ¥22.146（含み損¥-1）
**時間足**: **5分足（短期スキャルピング）** ⭐**重要変更**
**チェック間隔**: **300秒（5分）**
**主要指標**: **MACD + RSI + Bollinger Bands（5分足最適化）**
**ボット**: optimized-bot (Railway環境で自動稼働中)
**ダッシュボード**:
- ✅ **ローカル**: http://localhost:8082/
- ✅ **Railway**: https://web-production-1f4ce.up.railway.app/
- ✅ **ログ監視（改善版）**: https://web-production-1f4ce.up.railway.app/logs
**最新修正**: 緊急再起動でBOT停止問題解決、残高回復（¥199 → ¥214）✅ **CRITICAL FIX**
**GitHubコミット履歴**:
- 0a2ab4f - 🚨 v2.6.1 - 緊急再起動（強制デプロイ）⭐**最新**
- f65e9de - 🔄 緊急再起動トリガー
- 6326f77 - ⚡ v2.6.0 - 5分足トレードへの変更
- f70c6ee - ⚖️ v2.5.1 - バランス型戦略
- d89654f - 🔧 v2.4.2 - RSI計算エラー修正
- ee8c473 - 🔧 v2.4.1 - 手数料計算エラー修正

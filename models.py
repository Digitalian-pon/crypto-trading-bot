...
def create_models():
    """Create database models after db is initialized"""
    global User, TradingSettings, Trade, MarketData
    ...
    # グローバル変数に設定して他のモジュールからアクセス可能にする
    globals()['User'] = User
    globals()['TradingSettings'] = TradingSettings
    globals()['Trade'] = Trade
    globals()['MarketData'] = MarketData
    
    return User, TradingSettings, Trade, MarketData

# 暫定的に空のクラスを定義（初期化前のエラーを防ぐ）
class User:
    pass
